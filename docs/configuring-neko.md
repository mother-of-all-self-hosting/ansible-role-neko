...
See its [environment variables](https://neko.m1k1o.net/docs/v3/configuration) for a complete list of Neko's config options that you can put in `neko_environment_variables_additional_variables`.
